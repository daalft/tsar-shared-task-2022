...
class TSAR2022_SharedTask_Evaluator(object):
    ...
    def print_output_results(self, Potential_at_1,
                                   ...
                                   Accuracy_at_4_at_top_gold_1=None,
                                   Accuracy_at_5_at_top_gold_1=None,
                                   Accuracy_at_6_at_top_gold_1=None,
                                   Accuracy_at_7_at_top_gold_1=None,
                                   Accuracy_at_8_at_top_gold_1=None,
                                   Accuracy_at_9_at_top_gold_1=None,
                                   Accuracy_at_10_at_top_gold_1=None):
        ...
        print('Accuracy@4@top_gold_1 = ' + str(Accuracy_at_4_at_top_gold_1))
        print('Accuracy@5@top_gold_1 = ' + str(Accuracy_at_5_at_top_gold_1))
        print('Accuracy@6@top_gold_1 = ' + str(Accuracy_at_6_at_top_gold_1))
        print('Accuracy@7@top_gold_1 = ' + str(Accuracy_at_7_at_top_gold_1))
        print('Accuracy@8@top_gold_1 = ' + str(Accuracy_at_8_at_top_gold_1))
        print('Accuracy@9@top_gold_1 = ' + str(Accuracy_at_9_at_top_gold_1))
        print('Accuracy@10@top_gold_1 = ' + str(Accuracy_at_10_at_top_gold_1))
        print('\n')
...
def main():
    ...
    Accuracy_at_4_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(4)
    Accuracy_at_5_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(5)
    Accuracy_at_6_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(6)
    Accuracy_at_7_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(7)
    Accuracy_at_8_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(8)
    Accuracy_at_9_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(9)
    Accuracy_at_10_at_top_gold_1=evaluator.computeAccuracy_at_N_at_top_gold_1(10)
    ...
    Accuracy_at_4_at_top_gold_1_floored=math.floor(Accuracy_at_4_at_top_gold_1 * factor) / factor
    Accuracy_at_5_at_top_gold_1_floored=math.floor(Accuracy_at_5_at_top_gold_1 * factor) / factor
    Accuracy_at_6_at_top_gold_1_floored=math.floor(Accuracy_at_6_at_top_gold_1 * factor) / factor
    Accuracy_at_7_at_top_gold_1_floored=math.floor(Accuracy_at_7_at_top_gold_1 * factor) / factor
    Accuracy_at_8_at_top_gold_1_floored=math.floor(Accuracy_at_8_at_top_gold_1 * factor) / factor
    Accuracy_at_9_at_top_gold_1_floored=math.floor(Accuracy_at_9_at_top_gold_1 * factor) / factor
    Accuracy_at_10_at_top_gold_1_floored=math.floor(Accuracy_at_10_at_top_gold_1 * factor) / factor
    ...
    evaluator.print_output_results(Potential_at_1_floored,
                                   ...
                                   Accuracy_at_4_at_top_gold_1_floored,
                                   Accuracy_at_5_at_top_gold_1_floored,
                                   Accuracy_at_6_at_top_gold_1_floored,
                                   Accuracy_at_7_at_top_gold_1_floored,
                                   Accuracy_at_8_at_top_gold_1_floored,
                                   Accuracy_at_9_at_top_gold_1_floored,
                                   Accuracy_at_10_at_top_gold_1_floored)
